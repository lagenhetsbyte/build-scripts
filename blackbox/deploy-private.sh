...
COMMAND_4="curl -L https://raw.githubusercontent.com/lagenhetsbyte/build-scripts/master/blackbox/remove-private-registry-images.sh | bash -s BASE_PATH="/mnt/docker-registry-storage" REPO="$REPO" KEEP="5" TAG_PREFIX="$TAG_PREFIX""
