...
COMMAND_4="wget -N https://github.com/lagenhetsbyte/build-scripts/raw/master/blackbox/remove-private-registry-images.sh; sudo bash ./remove-private-registry-images.sh BASE_PATH="/mnt/docker-registry-storage" REPO="$REPO" KEEP="5" TAG_PREFIX="$TAG_PREFIX""
