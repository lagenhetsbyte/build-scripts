...
sudo grep -qxF '*/15 * * * * root /mnt/docker-registry-storage/registry-cleanup.sh' /etc/crontab || echo '*/15 * * * * root /mnt/docker-registry-storage/registry-cleanup.sh' >>/etc/crontab
